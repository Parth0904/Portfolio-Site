      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-10 text-center text-gray-300 space-y-2">
          ...
          <div className="flex justify-center gap-6 mt-2 text-5xl">
            <a href="https://www.upwork.com/freelancers/~YOUR_UPWORK_ID" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-400">
              <SiUpwork />
            </a>
            <a href="https://www.fiverr.com/YOUR_FIVERR_USERNAME" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-400">
              <SiFiverr />
            </a>
